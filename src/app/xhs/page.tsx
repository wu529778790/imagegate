...
import { DownloadOutlined, ThunderboltOutlined, MobileOutlined } from "@ant-design/icons";
  ...
  return (
    <div style={{ minHeight: "calc(100vh - 52px)" }}>
      <div style={{ padding: "24px 20px 100px", maxWidth: 900, margin: "0 auto" }}>
        ...
        <div className="glass" style={{ padding: "24px" }}>
          <Form form={form} layout="vertical" onFinish={handleGenerate} initialValues={{ style: "cute", layout: "balanced" }}>
            ...
            <Form.Item label={<span style={{ fontWeight: 600, color: "var(--text-secondary)" }}>视觉风格</span>}>
                  ...
                  <Tooltip key={s.value} title={s.description} placement="top">
                    <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.98 }}>
                      ...
                      >
                        ...
                        <div style={{ padding: "5px 0", textAlign: "center", fontSize: 11, fontWeight: 500, color: "var(--text-secondary)" }}>
                          {s.label}
                        </div>
                      </div>
                    </motion.div>
            ...
            <Form.Item label={<span style={{ fontWeight: 600, color: "var(--text-secondary)" }}>信息布局</span>}>
            ...
            <Form.Item name="palette" label={<span style={{ fontWeight: 600, color: "var(--text-secondary)" }}>配色方案</span>}>
      ...
      <Modal
        ...
        width={600}
        centered
        styles={{ body: { background: "var(--bg-primary)", padding: 0 } }}
      >
        {previewImage && (
